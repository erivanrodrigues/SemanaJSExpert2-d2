...
(() =>{
    ...
    atualizarTexto = ({elementoContador, contador}) =>() => {
        ...
        const textoPadao = `Começando em <strong>${identificadorTexto}</strong> segundos..`
        elementoContador.innerHTML = textoPadao.replace(identificadorTexto, contador.valor--)
    }
    ...
    inicializar() {
        ...
        
        {
            ...
            //const desabilitarBotao = () => console.log('Desabilizando...')
